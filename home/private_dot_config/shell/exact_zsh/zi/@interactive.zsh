...
# Install zie meta-plugin annex
zi light z-shell/z-a-meta-plugins

# Install zi annexes.
zi light-mode depth=1 for skip'readurl rust unscope' @annexes
zi light-mode depth=1 for id-as'annex/linkbin' z-shell/z-a-linkbin
